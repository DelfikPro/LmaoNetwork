...
import static pro.delfik.lmao.util.CryptoUtils.Keccak.HexUtils.getReverseHex;
...
public class CryptoUtils {
    ...
    private static long toLong(String message){
        ...
        for(int i = 0; i < message.length(); i++){
            ...
            if(i % 2 == 0)result = result + (int)c;
            else result = result * (int)c;
        }
        return result;
    }
